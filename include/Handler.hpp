...
namespace ChatLib::Handler {
    ...
    std::vector<ChatLib::Types::TwitchAuthorizedConnection> activeAuthorizedTwitchConnections;
    std::vector<ChatLib::Types::TwitchUnauthorizedConnection> activeUnauthorizedTwitchConnections;
